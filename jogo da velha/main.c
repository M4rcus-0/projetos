...
void iniciar(Jogo *jogo, bool resultado);
void resetar(char *tabuleiro);
void imprimir(char *tabuleiro);
bool checar(char *tabuleiro);
void movimentoPlayer(char *tabuleiro, char valor);
void movimentoComputador(char *tabuleiro, char valor);
void verificar(char *tabuleiro, Jogo *jogo, char *vencedor);
void Vencedor(char vencedor[]);
bool sortearPlayer();
...
int main()
{
    ...
    do
    {
        ...
        jogador = sorteio;
        while (strcmp(vencedor, " ") == 0 && checar(tabuleiro) == true)
        {
            imprimir(tabuleiro);
            if (jogador == true)
            {
            ...
            verificar(tabuleiro, &jogo, vencedor);
            ...
            else if (checar(tabuleiro) == false)
            {
                printf("Empate!\n");
                break;
            }
...
void modos(){
    // modo em que a cada 3 vezes jogadas de um player o proximo retira o primeiro colocado e assim segue
}
